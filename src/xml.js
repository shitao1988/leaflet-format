...
L.xml.makeObjectPropertyPusher = function(valueReader, opt_property, opt_this) {
  L.DEBUG && console.assert(valueReader !== undefined,
...
L.xml.makeChildAppender = function(nodeWriter, opt_this) {
  return function(node, value, objectStack) {
    ...
    L.DEBUG && console.assert(L.xml.isNode(parentNode) ||
        L.xml.isDocument(parentNode),
...
L.xml.makeSimpleNodeFactory = function(opt_nodeName, opt_namespaceURI) {
  ...
  return (
      ...
      function(value, objectStack, opt_nodeName) {
        ...
        L.DEBUG && console.assert(L.xml.isNode(node) || L.xml.isDocument(node),
        ...
        L.DEBUG && console.assert(nodeName !== undefined, 'nodeName was undefined');
